...
var Archia = (function () {
      ...
      jQuery(
        ...
        .on("click", function (e) {
          if (jQuery(this).hasClass("open")) {
            ...
            if (
              jQuery(this).parent("li").children(".sub-menu,.mega-menu")
                .length > 0
            ) {
              e.preventDefault();
  ...
  var MagnificPopup = function () {
    ...
    if (jQuery(".mfp-gallery-certificate").length) {
      jQuery(".mfp-gallery-certificate").magnificPopup({
        delegate: ".mfp-link",
        type: "image",
        tLoading: "Loading image #%curr%...",
        mainClass: "mfp-img-mobile",
  ...
  // var WebsiteLaunchDate = new Date("2025-08-20T01:01:00"); // TESTING
  // var WebsiteLaunchDate = new Date("2025-08-20T19:00:00"); // LIVE LAUNCH DATE
  var WebsiteLaunchDate = new Date("2025-12-25T00:00:00"); // X-mas launch: December 25, 2025 at midnight
...
jQuery(window).on("scroll", function () {
  if (jQuery(".sticky-header").length > 0) {
    ...
    if ($(window).scrollTop() > menu.offset().top) {
      ...
      if (jQuery('link[href*="css/dark.css"]').length > 0) {
        if (
          jQuery(".skin").attr("href") == "css/skin/color/skin-1.css" ||
          jQuery(".skin").attr("href") == "css/skin/skin-1.css"
        ) {
          $(".header-archia .container > .logo-header .logo").attr(
            "src",
